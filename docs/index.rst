...
of 3 sidereal days (slightly less than 72 hours). INTEGRAL was designed for a nominal lifetime of
...
of its reaction wheels and solar radiation pressure. It consists of four main scientific instruments:
...
3. The two X-ray monitors JEM-X (3-35 keV): Coded aperature mask with 2 high pressure microstrip
gas chambers. FOV 4.8°, detector area each 500 :math:`{\rm cm}^2`, spatial resolution 3´.
...
::
 ...
 @misc{GDT-INTEGRAL,
       author = {Suman Bala},
       title = {INTEGRAL Gamma-ray Data Tools: v1.0.0},
       year = 2024,
